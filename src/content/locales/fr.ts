...
const legalText = "Mention de copyright. Sauf indication contraire, tout le contenu de ce site, y compris les textes, images et documents téléchargeables, est protégé par le droit d'auteur et les droits voisins. Aucune partie de ce site ne peut être copiée, reproduite, modifiée, distribuée, stockée, transmise ou utilisée sous quelque forme que ce soit sans l'accord écrit préalable d'iiode, sauf pour un usage strictement personnel et non commercial, ou lorsque les conditions applicables sur ce site l'autorisent expressément. (c) 2026 iiode. Tous droits réservés.";
...
export const fr: LocaleContent = {
  ...
  pages: {
    ...
    about: {
      ...
      sections: ["iiode s'engage à dessiner l'avenir de l'électronique durable en développant des solutions responsables et faites pour durer, avec une attention particulière portée à l'éclairage conscient.", "Nous sommes spécialisés dans le développement de luminaires, d'installations, d'extensions de séries et de solutions allant du design à l'assemblage.", 'Nous créons aussi des espaces pour des événements et des intérieurs, en imaginant des narrations sensorielles qui offrent des expériences immersives.'],
  ...
  downloads: {
    ...
    pressContactLine: 'Pour les fichiers haute résolution et les demandes presse détaillées, veuillez contacter iiode',
  },
  re27: {
    hero: {
      title: 'iiode Re27',
    ...
    story: {
      leftText: "iiode Re27 est née d'une idée simple : une meilleure ampoule LED. C'est notre premier étape vers un avenir durable pour l'éclairage.",
      leftCallout: 'Suivez-nous',
      rightTitle: 'Un éclairage conscient',
      rightImage: re27Assets.storyImage,
    },
    useCases: {
      leftTitle: 'iiode Re27 est la seule ampoule qui associe qualité de lumière naturelle, contrôle intelligent intégré et matériaux recyclés dans un design réparable.',
      ...
      groups: [
        {
          ...
          bullets: ['Qualité de lumière naturelle avec IRC* élevé pour des couleurs fidèles', 'Gradation fluide et de haute qualité, sans scintillement', 'Intensité et température de lumière réglables'],
        },
        {
          heading: 'Elle est simple à utiliser et réparable par conception.',
          bullets: ["Le retrofit iiode Re27 s'installe dans les douilles existantes", 'Maintenance facilitée grâce à des composants modulaires clipsables', 'Démontable pour le recyclage'],
        },
        {
          heading: 'Elle constitue une alternative plus durable aux LED conventionnelles.',
          bullets: ['Fabriquée principalement à partir de matériaux recyclés', "La réparabilité prolonge la durée de vie de l'ampoule et du luminaire", "Assemblée en Suisse avec des composants majoritairement fabriqués dans l'UE"],
        },
      ],
    ...
    threeD: {
      ...
      durationSeconds: 1.0,
      compositionItems: ['Lentille optique en polycarbonate 100% recyclé post-production pour une diffusion efficace de la lumière', 'Circuit imprimé LED avec réseau LED blanc réglable à double canal pour des couleurs naturelles', 'Circuit imprimé logique avec contrôle à distance Wi-Fi et BLE, et accès aux données pour une connectivité intelligente', "Dissipateur thermique en mousse d'aluminium à cellules ouvertes 100% recyclée pour la dissipation de chaleur", 'Circuit imprimé driver avec convertisseur AC -> DC miniaturisé pour la régulation de puissance', 'Douille E27 standard pour un remplacement sans outil'],
    ...
    gallery: {
      ...
      rightText: "De la maison à l'hôtellerie, du retail aux espaces de travail, iiode Re27 illumine les lieux pour y garantir confort, beauté et productivité.",
    },
    workWithUs: {
      ...
      items: [
        {
          title: 'Fabricants',
          body: 'Intégrez des fonctionnalités avancées dans vos designs tout en simplifiant la construction et la maintenance.',
        },
        {
          title: 'Distributeurs',
          body: 'Proposez iiode Re27 comme complément à des luminaires neufs ou vintage, et comme ampoule de remplacement durable.',
        },
        {
          title: 'Designers et architectes',
          body: "Enrichissez vos projets avec des solutions d'éclairage augmentées par iiode Re27 ou des designs sur mesure.",
        },
      ],

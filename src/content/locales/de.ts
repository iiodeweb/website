...
export const de: LocaleContent = {
  ...
  pages: {
    ...
    about: {
      ...
      sections: ['iiode setzt sich dafür ein, die Zukunft nachhaltiger Elektronik mit langlebigen und verantwortungsvollen Lösungen zu gestalten, mit besonderem Fokus auf bewusstes Licht.', 'Wir sind spezialisiert auf die Entwicklung von Leuchten, Installationen, Serienerweiterungen und Lösungen vom Design bis zur Montage.', 'Ausserdem gestalten wir Räume für Events und Interieurs und entwickeln sensorische Erzählungen, die immersive Erlebnisse schaffen.'],
  ...
  downloads: {
    ...
    pressContactLine: 'Für hochauflösende Dateien und detaillierte Presseanfragen kontaktieren Sie bitte iiode',
  },
  re27: {
    hero: {
      title: 'iiode Re27',
    ...
    story: {
      leftText: 'iiode Re27 entstand aus einer einfachen Idee: einer besseren LED-Glühbirne. Das ist unser erster von vielen Schritten in eine nachhaltige Zukunft des Lichts.',
      leftCallout: 'Folgen Sie uns',
      rightTitle: 'Bewusst gestaltetes Licht',
      rightImage: re27Assets.storyImage,
    },
    useCases: {
      leftTitle: 'iiode Re27 ist die einzige Glühbirne, die natürliche Lichtqualität, integrierte smarte Steuerung und recycelte Materialien in einem servicefähigen Design vereint.',
      ...
      groups: [
        {
          ...
          bullets: ['Natürliche Lichtqualität mit hohem CRI* für farbechte Wiedergabe', 'Flimmerfreies, hochwertiges Dimmen', 'Regelbare Lichtintensität und Farbtemperatur'],
        },
        {
          heading: 'Sie ist einfach zu bedienen und servicefähig konstruiert.',
          bullets: ['Das iiode Re27 Retrofit passt in bestehende Fassungen', 'Einfache Wartung dank modularer, einklickbarer Komponenten', 'Kann für das Recycling zerlegt werden'],
        },
        {
          heading: 'Sie ist eine nachhaltigere Alternative zu konventionellen LEDs.',
          bullets: ['Grösstenteils aus recycelten Materialien gefertigt', 'Servicefähigkeit verlängert die Lebensdauer von Glühbirne und Leuchte', 'Montiert in der Schweiz mit überwiegend in der EU gefertigten Teilen'],
        },
      ],
    ...
    threeD: {
      ...
      durationSeconds: 1.0,
      compositionItems: ['Optische Linse aus 100% post-production recyceltem Polycarbonat für effiziente Lichtstreuung', 'LED-Leiterplatte mit zweikanaligem, abstimmbarem Weisslicht-LED-Array für natürliche Farben', 'Logik-Leiterplatte mit Wi-Fi- und BLE-Fernsteuerung sowie Datenzugang für smarte Konnektivität', 'Kühlkörper aus 100% recyceltem offenzelligem Aluminiumschaum zur Wärmeableitung', 'Driver-Leiterplatte mit miniaturisiertem AC -> DC-Treiber zur Leistungsregelung', 'Standard-E27-Fassung für werkzeugfreien Austausch'],
    ...
    gallery: {
      ...
      rightText: 'Von Zuhause und Hospitality bis Retail und Arbeitsräumen: iiode Re27 beleuchtet Räume mit Komfort, Schönheit und Produktivität.',
    },
    workWithUs: {
      ...
      items: [
        {
          title: 'Hersteller',
          body: 'Integrieren Sie erweiterte Funktionen in Ihre Designs und vereinfachen Sie gleichzeitig Konstruktion und Wartung.',
        },
        {
          title: 'Händler',
          body: 'Bieten Sie iiode Re27 als Begleiter für neue oder Vintage-Leuchten und als nachhaltige Ersatz-Glühbirne an.',
        },
        {
          title: 'Designer und Architekten',
          body: 'Erweitern Sie Ihre Projekte mit durch iiode Re27 verbesserten Lichtlösungen oder individuellen Designs.',
        },
      ],

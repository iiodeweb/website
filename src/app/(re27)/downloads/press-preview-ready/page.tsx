  ...
  return (
    <section className="bg-background text-foreground">
      <div className="iiode-section-wrap" data-scroll-track="true">
        <div
          className="iiode-container iiode-section-panel iiode-split-grid grid grid-cols-1"
          data-scroll-panel="true"
        >
          <div className="iiode-split-half iiode-text-half iiode-half-pad-2 flex items-start pt-10 md:pt-8">
